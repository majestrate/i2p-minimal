...
public class RouterManager {
    ...
    private final static String I2P_DIR = System.getProperty("user.home") + File.separator + ".i2p";
    private final static String I2P_CONFIG_FILE = I2P_DIR + File.separator + "i2p.conf";
